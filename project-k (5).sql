...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2025 at 04:01 PM
...
INSERT INTO `central_files` (`event`, `event_name`, `file_name`, `file_path`, `uploaded_by`, `photo1`, `photo2`, `photo3`, `photo4`) VALUES
...
('event1', '', 'file1', 'uploads/gmr_landing_page (1).jpg', 'chandru', '', '', '', ''),
('event2', '', 'kk', 'uploads/gmr_landing_page.jpg', 'sekhar', '', '', '', ''),
('women', '', 'cert', 'uploads/gmr_landing_page (1).jpg', 'kalyan', '', '', '', ''),
('women', '', 'cert', 'uploads/gmr_landing_page (1).jpg', 'kalyan', '', '', '', ''),
('file', '', 'll', 'uploads/gmr_landing_page (1).jpg', 'll', '', '', '', ''),
('Sports', '', 'gmr_league_files', 'uploads/gmr_landing_page (2).jpg', 'chandu', 'uploads/gmr_landing_page (2).jpg', 'uploads/gmr_landing_page (2).jpg', NULL, NULL),
('Women Empowerment', 'empowerment_event', 'event1', 'uploads/gmr (1).png', 'kalyan', 'uploads/cat.jpg', NULL, NULL, NULL),
('PASH', 'pash event', 'pash file', 'uploads/qr_code (2).png', 'chandru', 'uploads/iit mandi.webp', NULL, NULL, NULL),
('NCC', 'ncc_event1', 'document1', 'uploads/iit mandi.webp', 'chandu', 'uploads/gmr (1) (1).png', 'uploads/file_management (1).jpeg', NULL, NULL);
...
INSERT INTO `dept_files` (`id`, `username`, `dept`, `file_type`, `sub_file_type`, `file_name`, `file_path`) VALUES
...
(8, 'chandu', '', 'admin', 'Departmental Library Details', 'file11', 'uploads/imresizer-1723467344733_28 (1).jpg'),
(9, 'chandu', '', 'faculty', 'Consultancy and Corporate Training', 'faculty_det', 'uploads/file_management (1).jpeg'),
(10, 'chandu', '', 'admin', 'List of Projects', 'lasjfd', 'uploads/c_down_files.php'),
(11, 'chandu', '', 'admin', 'Course Structure', 'file1', 'uploads/AWS-certificate.pdf'),
(12, 'Chandru', '', 'student', 'List of Forms', 'file_student', 'uploads/Chandrasekhar-resume.pdf'),
(13, 'chandu', 'AIML', 'admin', 'Guest Lectures', 'file2', 'uploads/gmr_landing_page (3).jpg');
...
INSERT INTO `fdps_org_tab` (`id`, `username`, `branch`, `title`, `date_from`, `date_to`, `organised_by`, `location`, `certificate`, `brochure`, `fdp_schedule_invitation`, `attendance_forms`, `feedback_forms`, `fdp_report`, `photo1`, `photo2`, `photo3`, `submission_time`) VALUES
(1, 'chandu', 'AIML', 'fdps organisation1', '2025-01-01', '2025-01-31', 'gmr', 'rajam', 'uploads/certificates/AWS-certificate.pdf', 'uploads/certificates/AWS-certificate.pdf', 'uploads/certificates/AWS-certificate.pdf', 'uploads/certificates/AWS-certificate.pdf', 'uploads/certificates/BASAVADURGA_22341A0312_1733812438576.pdf', 'uploads/certificates/Chandrasekhar-cv.pdf', 'uploads/certificates/gmr (1) (1).png', 'uploads/certificates/iit mandi.webp', 'uploads/certificates/gmr.png', '2025-01-08 18:48:38');
...
(8, 'chandu', 'AIML', 'aa', '2025-01-01', '2025-01-31', 'gmr', 'rajam', 'uploads/certificates/gmr_landing_page (1) (1).jpg', '2025-01-06 17:18:16'),
(9, 'chandu', 'AIML', 'chandu', '2025-01-01', '2025-01-31', 'aitam', 'tekkali', 'uploads/certificates/file_management (1).jpeg', '2025-01-07 17:25:20');
...
(68, 'chandu', '2022-23', '', 0, '', 'chandu', '', '2025-01-07 17:24:31.000000', 'file1', 'uploads/black-and-white-pictures-of-flowers-26-1.jpeg', 2, '2.1.1(A)');
...
INSERT INTO `reg_tab` (`emp_name`, `emp_no`, `dept`, `date_of_joining`, `aadhar`, `pan`, `phone`, `address`, `orc_id`, `scopus_id`, `vidwan_id`, `def_id`, `userid`, `password`, `photo_path`) VALUES
...
('chandrasekhar', '123', 'CSE', '2024-01-02', 2147483647, 'AKDIK1234K', 2147483647, 'sompeta, srikaulam', '', '', '', '', 'Chandra', '123', 'uploads/IMG_20240322_114300 - Copy.jpg'),
('chandu', '52', 'CSE', '2025-01-03', 2147483647, 'AKDIK1234K', 2147483647, 'srikakulam', '123', '123r', '123e', '123r', 'chandru', '123', ''),
('sdfj', '22', 'AIML', '2024-10-30', 2147483647, 'AKDIK1234K', 2147483647, 'qer', 'wer', 'qe', 'qwer', 'qwer', 'chandu', '123', 'uploads/1711562825634 - Copy.jpg');
...
INSERT INTO `s_bodies` (`id`, `Body`, `event_name`, `from_date`, `to_date`, `organised_by`, `location`, `participation_status`, `certificate_path`, `uploaded_by`, `submission_time`) VALUES
(0, 'CSI', 'event1', '2025-01-14', '2025-01-31', 'gmr', 'rajam', '2nd', 'uploads/gmr_landing_page (1).jpg', 'chandru', '05-01-2025 19:34:58');
...
INSERT INTO `s_conference_tab` (`id`, `uploaded_by`, `paper_title`, `from_date`, `to_date`, `organised_by`, `location`, `certificate_path`, `paper_type`, `paper_file_path`, `submission_time`) VALUES
(1, 'chandu', 'paper1', '2025-01-01', '2025-01-31', 'gmr', 'rajam', 'uploads/gmr_landing_page (1).jpg', 'participated', '', '2025-01-05 13:52:55'),
(2, 'sekhar', 'papert', '2025-01-01', '2025-01-31', 'gmrit', 'rajam', 'uploads/gmr_landing_page (1).jpg', 'participated', '', '05-01-2025 13:01:26');
...
INSERT INTO `s_events` (`id`, `activity`, `event_name`, `from_date`, `to_date`, `organised_by`, `location`, `participation_status`, `certificate_path`, `uploaded_by`, `submission_time`) VALUES
...
INSERT INTO `s_journal_tab` (`id`, `uploaded_by`, `paper_title`, `journal_name`, `indexing`, `date_of_submission`, `quality_factor`, `impact_factor`, `payment`, `submission_time`, `paper_file`) VALUES
